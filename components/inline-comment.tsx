...
export function InlineComment({ comments, onAddComment, onCancel, isNew = false }: InlineCommentProps) {
  ...
  return (
    <div className="pl-12 border-l-2 border-blue-500/20 bg-blue-500/5 py-3 mt-2 mb-4">
      {/* Existing comments */}
